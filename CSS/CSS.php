...
class CSS
{
    ...
    {
        if (is_front_page()) {
            $filePath = SEVEN_TECH_LOCATION_URL . 'CSS/seven-tech-location.css';

            if ($filePath) {
                wp_register_style('seven_tech_location_css',  SEVEN_TECH_LOCATION_URL . 'CSS/seven-tech-location.css', array(), false, 'all');
                wp_enqueue_style('seven_tech_location_css');
            } else {
