...
class JS
{
    ...
    function load_js()
    {
        wp_register_script('seven_tech_js', SEVEN_TECH_LOCATION_URL . 'JS/seven-tech.js', array('jquery'), false, false);
    ...
    function load_front_page_react()
    {
        ...
        foreach ($sections as $section) {
            if (is_front_page()) {
                ...
                $filePath = SEVEN_TECH_LOCATION_URL . 'build/' . 'src_views_' . $fileName . '_jsx.js';
                ...
                wp_enqueue_script('seven_tech_react_index', SEVEN_TECH_LOCATION_URL . 'build/' . 'index.js', ['wp-element'], 1.0, true);
            }
        }
    }
